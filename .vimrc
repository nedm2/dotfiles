...
" CocList shortcuts (these are currently disables as I don't use them)
...
" Cannot remember why I added these :(
let &t_TI = ""
let &t_TE = ""

" macro convenience (qq __record__ q <Space>)
:nnoremap <Space> @q

" Change gutter background to black. Not sure why this is necessary, probably
" some other plugin is screwing up the background colour.
